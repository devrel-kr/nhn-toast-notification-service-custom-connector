...
namespace Toast.Sms.Triggers
{
    public class ListMessages
    {
        ...
        [OpenApiParameter(name: "requestId", Type = typeof(string), In = ParameterLocation.Query, Required = false, Description = "RequestId to search\nrequestId or startRequestDate + endRequestDate or startCreateDate + endCreateDate must be filled")]
        ...
        [OpenApiParameter(name: "msgStatus", Type = typeof(string), In = ParameterLocation.Query, Required = false, Description = "Message state code(0: fail, 1: request, 2: processing, 3: success, 4: Reservation cancellation, 5: Duplicate failed)")]
